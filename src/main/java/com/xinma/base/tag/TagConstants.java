...
public class TagConstants {
	...
	/**
	 * 该字符表用于displayCode编码, 由数字0~9 ，大写英文字母(I O 除外)，特殊字符 + - 组成
	 */
	protected static final char codeTable36[] = { 'E', 'B', 'A', 'S', 'M', '5', 'F', 'G', 'C', 'L', 'H', 'Z', '-', 'D',
			'4', '1', 'W', '3', 'T', 'P', 'Y', '9', '8', 'R', 'J', '2', '+', '0', '7', 'N', 'X', 'V', 'Q', '6', 'K',
			'U' };

	/**
	 * 该字符表用于CODE_VERSION_1的hiddenCode编码
	 */
	protected static final char codeTable40[] = { 'C', '5', 'K', 'Y', 'G', 'R', 'F', 'E', 'T', '6', 'V', '*', 'H', 'Q',
			'1', 'B', 'A', '4', '0', '9', 'X', 'U', '8', '-', 'P', 'W', '7', 'D', 'I', '!', 'L', 'Z', '$', 'O', 'J',
			'N', '2', 'M', 'S', '3' };
